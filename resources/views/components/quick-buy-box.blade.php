<div class="bg-white rounded-xl shadow-lg overflow-hidden quick-buy-container w-full lg:w-[550px] h-auto lg:h-[320px] flex flex-col relative lg:absolute lg:left-[-30px] lg:top-[-100px] z-10">
