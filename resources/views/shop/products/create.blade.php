            ...
            <form action="{{ route('shop.products.store') }}" method="POST" enctype="multipart/form-data" id="productForm">
                        ...
                        <div class="flex gap-4 mt-3">
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" 
                                       ...
                                       value="1" 
                                       {{ old('requires_prescription') == '1' ? 'checked' : '' }}
                            ...
                            <label class="flex items-center cursor-pointer">
                                <input type="radio" 
                                       name="requires_prescription" 
                                       value="0" 
                                       {{ old('requires_prescription', '0') == '0' ? 'checked' : '' }}
                                       class="w-4 h-4 text-purple-600 focus:ring-purple-500 border-gray-300 dark:border-gray-600">
                ...
                <div class="mt-6">
                    ...
                    <textarea name="side_effects" 
                              ...
                              class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white @error('side_effects') border-red-500 shake @enderror">{{ old('side_effects') }}</textarea>
                    @error('side_effects')
                    <p class="mt-1 text-sm text-red-500"><i class='bx bx-error-circle'></i> {{ $message }}</p>
                    @enderror
                </div>
